...
void InterfaceSettingsScreen::onRedraw(draw_mode_t what) {
  ...
  if (what & FOREGROUND) {
<<<<<<< HEAD:Marlin/src/lcd/extui/ftdi_eve_touch_ui/generic/interface_settings_screen.cpp
...
>>>>>>> OficialRepo/2.0.x:Marlin/src/lcd/extui/lib/ftdi_eve_touch_ui/screens/interface_settings_screen.cpp
    #endif
